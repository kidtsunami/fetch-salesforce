import { withDefaults, formatApiVersion } from '../../lib/salesforceOptions';
export function withValidSalesforceOptions() {
    let testOptions = {
...
export function withRequiredSalesforceOptions() {
    let testOptions = {
